...
// CHECK-NEXT:   %1 = load ptr, ptr @main._cgo_{{.*}}_Cfunc_cos, align 8
// CHECK-NEXT:   %2 = load ptr, ptr %1, align 8
// CHECK-NEXT:   %3 = call double %2(double %0)
...
// CHECK-NEXT:   %.stack = alloca i8, i64 8, align 1
// CHECK-NEXT:   call void @llvm.memset.p0.i64(ptr %.stack, i8 0, i64 8, i1 false)
// CHECK-NEXT:   %1 = load ptr, ptr @main._cgo_{{.*}}_Cfunc_log, align 8
// CHECK-NEXT:   %2 = load ptr, ptr %1, align 8
// CHECK-NEXT:   %3 = call double %2(double %0)
// CHECK-NEXT:   ret double %3
// CHECK-NEXT: }
...
// CHECK-NEXT:   %.stack = alloca i8, i64 8, align 1
// CHECK-NEXT:   call void @llvm.memset.p0.i64(ptr %.stack, i8 0, i64 8, i1 false)
// CHECK-NEXT:   %1 = load ptr, ptr @main._cgo_{{.*}}_Cfunc_puts, align 8
// CHECK-NEXT:   %2 = load ptr, ptr %1, align 8
// CHECK-NEXT:   %3 = call i32 %2(ptr %0)
...
// CHECK-NEXT:   %.stack = alloca i8, i64 8, align 1
// CHECK-NEXT:   call void @llvm.memset.p0.i64(ptr %.stack, i8 0, i64 8, i1 false)
// CHECK-NEXT:   %1 = load ptr, ptr @main._cgo_{{.*}}_Cfunc_sin, align 8
// CHECK-NEXT:   %2 = load ptr, ptr %1, align 8
// CHECK-NEXT:   %3 = call double %2(double %0)
// CHECK-NEXT:   ret double %3
// CHECK-NEXT: }
...
// CHECK-NEXT:   %.stack = alloca i8, i64 8, align 1
// CHECK-NEXT:   call void @llvm.memset.p0.i64(ptr %.stack, i8 0, i64 8, i1 false)
// CHECK-NEXT:   %1 = load ptr, ptr @main._cgo_{{.*}}_Cfunc_sqrt, align 8
// CHECK-NEXT:   %2 = load ptr, ptr %1, align 8
// CHECK-NEXT:   %3 = call double %2(double %0)
// CHECK-NEXT:   ret double %3
// CHECK-NEXT: }
