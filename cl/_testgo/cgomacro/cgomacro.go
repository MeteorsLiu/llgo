...
// ESCAPE: %3 = load ptr, ptr @main._cgo_{{.*}}_Cfunc_PyObject_Print, align 8
// ESCAPE: %4 = load ptr, ptr %3, align 8
// ESCAPE: %5 = call i32 %4(ptr %0, ptr %1, i32 %2)
// ESCAPE: ret i32 %5

// ESCAPE-LABEL: define i32 @main._Cfunc_fputs(ptr %0, ptr %1){{.*}} {
// ESCAPE: %.stack = alloca i8, i64 8, align 1
// ESCAPE: call void @llvm.memset.p0.i64(ptr %.stack, i8 0, i64 8, i1 false)
// ESCAPE: %2 = load ptr, ptr @main._cgo_{{.*}}_Cfunc_fputs, align 8
// ESCAPE: %3 = load ptr, ptr %2, align 8
// ESCAPE: %4 = call i32 %3(ptr %0, ptr %1)
// ESCAPE: ret i32 %4

// ESCAPE-LABEL: define ptr @main._Cmacro_Py_False(){{.*}} {
// ESCAPE: %.stack = alloca i8, i64 8, align 1
// ESCAPE: call void @llvm.memset.p0.i64(ptr %.stack, i8 0, i64 8, i1 false)
// ESCAPE: %0 = load ptr, ptr @main._cgo_{{.*}}_Cmacro_Py_False, align 8
// ESCAPE: %1 = load ptr, ptr %0, align 8
// ESCAPE: ret ptr %1

// ESCAPE-LABEL: define ptr @main._Cmacro_Py_None(){{.*}} {
// ESCAPE: %.stack = alloca i8, i64 8, align 1
// ESCAPE: call void @llvm.memset.p0.i64(ptr %.stack, i8 0, i64 8, i1 false)
// ESCAPE: %0 = load ptr, ptr @main._cgo_{{.*}}_Cmacro_Py_None, align 8
// ESCAPE: %1 = load ptr, ptr %0, align 8
// ESCAPE: ret ptr %1
...
// ESCAPE: %.stack = alloca i8, i64 8, align 1
// ESCAPE: call void @llvm.memset.p0.i64(ptr %.stack, i8 0, i64 8, i1 false)
// ESCAPE: %0 = load ptr, ptr @main._cgo_{{.*}}_Cmacro_Py_True, align 8
// ESCAPE: %1 = load ptr, ptr %0, align 8
// ESCAPE: ret ptr %1
...
// ESCAPE: %.stack = alloca i8, i64 8, align 1
// ESCAPE: call void @llvm.memset.p0.i64(ptr %.stack, i8 0, i64 8, i1 false)
// ESCAPE: %0 = load ptr, ptr @main._cgo_{{.*}}_Cmacro_stdout, align 8
// ESCAPE: %1 = load ptr, ptr %0, align 8
// ESCAPE: ret ptr %1
